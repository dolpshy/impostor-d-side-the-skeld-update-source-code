...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		new OptionCategory("Gameplay", [
			...
			new AccuracyDOption("Change how accuracy is calculated. (Accurate = Ratings Based, MS Based = Milisecond Based)"),
		...
		new OptionCategory("Appearance", [
			...
			new NoteSplashes("Show note splash on pressing sick."),
