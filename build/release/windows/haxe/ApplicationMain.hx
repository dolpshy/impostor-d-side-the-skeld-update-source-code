...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Vs Impostor D-Side", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Vs Impostor D-Side", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "120";
		app.meta["company"] = "Shyllis";
		app.meta["file"] = "Vs Impostor D-Side";
		app.meta["name"] = "Vs Impostor D-Sides";
		app.meta["packageName"] = "com.shyllis.vsimpostordsides";
