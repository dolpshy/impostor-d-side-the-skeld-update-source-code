...
HXLINE(  13)		::haxe::Log_obj::trace(HX_("Discord Client starting...",0d,5b,39,a8),::hx::SourceInfo(HX_("code/Discord.hx",94,c5,cc,85),13,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
HXLINE(  14)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("981389492248252466",90,53,09,d2))
            			->setFixed(3,HX_("onReady",c4,3e,f8,7c),::DiscordClient_obj::onReady_dyn())));
HXLINE(  20)		::haxe::Log_obj::trace(HX_("Discord Client started.",8e,09,8e,36),::hx::SourceInfo(HX_("code/Discord.hx",94,c5,cc,85),20,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
...
HXDLIN(  39)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("Vs Impostor D-Side",56,45,d7,c4))));
            	}
...
HXDLIN(  49)		::haxe::Log_obj::trace((((HX_("Error! ",87,92,5b,b7) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("code/Discord.hx",94,c5,cc,85),49,HX_("DiscordClient",f7,d0,c5,2b),HX_("onError",29,6a,67,09)));
            	}
...
HXDLIN(  54)		::haxe::Log_obj::trace((((HX_("Disconnected! ",7a,e1,87,53) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("code/Discord.hx",94,c5,cc,85),54,HX_("DiscordClient",f7,d0,c5,2b),HX_("onDisconnected",7a,eb,5a,b8)));
            	}
...
HXLINE(  63)		::haxe::Log_obj::trace(HX_("Discord Client initialized",f3,a9,32,06),::hx::SourceInfo(HX_("code/Discord.hx",94,c5,cc,85),63,HX_("DiscordClient",f7,d0,c5,2b),HX_("initialize",50,31,bb,ec)));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(DiscordClient_obj,initialize,(void))

void DiscordClient_obj::changePresence(::String details,::String state,::String largeImageKey,::String smallImageKey, ::Dynamic hasStartTimestamp, ::Dynamic endTimestamp){
...
HXLINE(  75)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(7)
            			...
            			->setFixed(3,HX_("largeImageKey",df,8f,e3,ae),largeImageKey)
            			...
            			->setFixed(6,HX_("largeImageText",6d,3e,2d,5e),HX_("Vs Impostor D-Side",56,45,d7,c4))));
            	}
