...
HXDLIN(  78)		_hx_tmp(((_hx_tmp1 + this->path) + HX_(" replay...",07,d7,a1,13)),::hx::SourceInfo(HX_("code/Replay.hx",35,bb,d6,07),78,HX_("Replay",47,5b,16,3b),HX_("LoadFromJSON",f8,e4,96,25)));
HXLINE(  79)		try {
...
HXDLIN(  86)					_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("code/Replay.hx",35,bb,d6,07),86,HX_("Replay",47,5b,16,3b),HX_("LoadFromJSON",f8,e4,96,25)));
            				}
            			}
            			else {
