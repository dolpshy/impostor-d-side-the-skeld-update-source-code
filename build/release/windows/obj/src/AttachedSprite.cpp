...
void AttachedSprite_obj::__construct(::String file,::String library,::String anim, ::Dynamic __o_loop){
...
HXLINE(  23)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + file) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
...
HXLINE(  27)			this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + file) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
            		}
...
::hx::ObjectPtr< AttachedSprite_obj > AttachedSprite_obj::__new(::String file,::String library,::String anim, ::Dynamic __o_loop) {
	::hx::ObjectPtr< AttachedSprite_obj > __this = new AttachedSprite_obj();
	__this->__construct(file,library,anim,__o_loop);
	return __this;
}

::hx::ObjectPtr< AttachedSprite_obj > AttachedSprite_obj::__alloc(::hx::Ctx *_hx_ctx,::String file,::String library,::String anim, ::Dynamic __o_loop) {
