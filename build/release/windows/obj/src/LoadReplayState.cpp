...
HXLINE(  38)		::haxe::Log_obj::trace(this->controlsStrings,::hx::SourceInfo(HX_("code/LoadReplayState.hx",5c,ef,03,a0),38,HX_("LoadReplayState",c4,3c,20,8a),HX_("create",fc,66,0f,7c)));
...
HXDLIN(  66)				menuBG1->set_x(((( (Float)(_hx_tmp) ) - menuBG1->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  66)				menuBG1->set_y(((( (Float)(_hx_tmp) ) - menuBG1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  84)		{
HXLINE(  84)			 ::flixel::math::FlxBasePoint this1 = this->versionShit->scrollFactor;
...
HXLINE(  90)		{
HXLINE(  90)			 ::flixel::math::FlxBasePoint this2 = this->poggerDetails->scrollFactor;
...
HXLINE( 146)			::haxe::Log_obj::trace((HX_("loading ",24,de,81,cb) + this->actualNames->__get(this->curSelected)),::hx::SourceInfo(HX_("code/LoadReplayState.hx",5c,ef,03,a0),146,HX_("LoadReplayState",c4,3c,20,8a),HX_("update",09,86,05,87)));
