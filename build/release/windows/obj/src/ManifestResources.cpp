...
HXLINE(  90)		{
HXLINE(  90)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/songs.json",38,27,75,ee));
HXDLIN(  90)			::lime::utils::Assets_obj::libraryPaths->set(HX_("songs",fe,36,c7,80),v);
            		}
HXLINE(  91)		{
HXLINE(  91)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/shared.json",f1,c2,0a,f4));
HXDLIN(  91)			::lime::utils::Assets_obj::libraryPaths->set(HX_("shared",a5,5e,2b,1d),v1);
            		}
HXLINE(  92)		{
HXLINE(  92)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  92)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v2);
            		}
HXLINE(  77)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE(  96)		if (::hx::IsNotNull( library )) {
HXLINE(  96)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  97)			::ManifestResources_obj::preloadLibraryNames->push(HX_("songs",fe,36,c7,80));
            		}
HXLINE(  98)		library = ::lime::utils::Assets_obj::getLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE(  99)		if (::hx::IsNotNull( library )) {
HXLINE(  99)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 100)			::ManifestResources_obj::preloadLibraryNames->push(HX_("shared",a5,5e,2b,1d));
            		}
