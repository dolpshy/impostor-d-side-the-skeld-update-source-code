...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_163_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",163,0x1a8855ec)
...
HXLINE(  62)		{
HXLINE(  62)			::String _g = ( (::String)(::PlayState_obj::SONG->__Field(HX_("noteStyle",df,ef,aa,c1),::hx::paccDynamic)) );
HXLINE(  64)			{
HXLINE(  65)				::String library = null();
HXDLIN(  65)				::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  65)				this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
...
HXLINE(  87)		switch((int)(noteData)){
            			case (int)0: {
HXLINE(  90)				this->set_x((this->x + (::Note_obj::swagWidth * ( (Float)(0) ))));
HXLINE(  91)				this->animation->play(HX_("purpleScroll",69,97,67,99),null(),null(),null());
            			}
            			break;
            			case (int)1: {
HXLINE(  93)				this->set_x((this->x + ::Note_obj::swagWidth));
HXLINE(  94)				this->animation->play(HX_("blueScroll",47,7e,59,a2),null(),null(),null());
            			}
            			break;
            			case (int)2: {
HXLINE(  96)				this->set_x((this->x + (::Note_obj::swagWidth * ( (Float)(2) ))));
HXLINE(  97)				this->animation->play(HX_("greenScroll",30,4f,fe,9e),null(),null(),null());
            			}
            			break;
            			case (int)3: {
HXLINE(  99)				this->set_x((this->x + (::Note_obj::swagWidth * ( (Float)(3) ))));
HXLINE( 100)				this->animation->play(HX_("redScroll",3e,78,c3,3a),null(),null(),null());
            			}
            			break;
            		}
HXLINE( 108)		bool _hx_tmp1;
HXDLIN( 108)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )) {
HXLINE( 108)			_hx_tmp1 = ( (bool)(sustainNote) );
            		}
            		else {
HXLINE( 108)			_hx_tmp1 = false;
            		}
HXDLIN( 108)		if (_hx_tmp1) {
HXLINE( 109)			this->set_flipY(true);
            		}
HXLINE( 111)		bool _hx_tmp2;
HXDLIN( 111)		if (this->isSustainNote) {
HXLINE( 111)			_hx_tmp2 = ::hx::IsNotNull( prevNote );
            		}
            		else {
HXLINE( 111)			_hx_tmp2 = false;
            		}
HXDLIN( 111)		if (_hx_tmp2) {
HXLINE( 114)			this->set_alpha(((Float)0.6));
HXLINE( 116)			Float _hx_tmp = this->x;
HXDLIN( 116)			this->set_x((_hx_tmp + (this->get_width() / ( (Float)(2) ))));
HXLINE( 118)			switch((int)(noteData)){
            				case (int)0: {
HXLINE( 127)					this->animation->play(HX_("purpleholdend",40,d5,15,5b),null(),null(),null());
            				}
            				break;
            				case (int)1: {
HXLINE( 125)					this->animation->play(HX_("blueholdend",a2,f0,cd,25),null(),null(),null());
            				}
            				break;
            				case (int)2: {
HXLINE( 121)					this->animation->play(HX_("greenholdend",99,eb,5f,39),null(),null(),null());
            				}
            				break;
            				case (int)3: {
HXLINE( 123)					this->animation->play(HX_("redholdend",cb,ae,1e,ea),null(),null(),null());
            				}
            				break;
            			}
HXLINE( 130)			this->updateHitbox();
HXLINE( 132)			Float _hx_tmp1 = this->x;
HXDLIN( 132)			this->set_x((_hx_tmp1 - (this->get_width() / ( (Float)(2) ))));
HXLINE( 134)			if (::StringTools_obj::startsWith(::PlayState_obj::curStage,HX_("school",74,b8,c8,40))) {
HXLINE( 135)				this->set_x((this->x + 30));
            			}
HXLINE( 137)			if (prevNote->isSustainNote) {
HXLINE( 139)				switch((int)(prevNote->noteData)){
            					case (int)0: {
HXLINE( 142)						prevNote->animation->play(HX_("purplehold",7b,8d,da,cd),null(),null(),null());
            					}
            					break;
            					case (int)1: {
HXLINE( 144)						prevNote->animation->play(HX_("bluehold",d9,60,aa,a4),null(),null(),null());
            					}
            					break;
            					case (int)2: {
HXLINE( 146)						prevNote->animation->play(HX_("greenhold",82,f5,c1,bc),null(),null(),null());
            					}
            					break;
            					case (int)3: {
HXLINE( 148)						prevNote->animation->play(HX_("redhold",10,1f,bf,bf),null(),null(),null());
            					}
            					break;
            				}
HXLINE( 152)				if (::hx::IsNotEq( ::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic),1 )) {
HXLINE( 153)					prevNote->scale->set_y((prevNote->scale->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.5)) * ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic)) ))));
            				}
            				else {
HXLINE( 155)					prevNote->scale->set_y((prevNote->scale->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.5)) * ( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) ))));
            				}
HXLINE( 156)				prevNote->updateHitbox();
            			}
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_163_update)
HXLINE( 164)		this->super::update(elapsed);
HXLINE( 166)		if (this->mustPress) {
HXLINE( 169)			if (this->isSustainNote) {
HXLINE( 171)				bool _hx_tmp;
HXDLIN( 171)				if ((this->strumTime > (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * ((Float)1.5))))) {
HXLINE( 171)					_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * ((Float)0.5))));
            				}
            				else {
HXLINE( 171)					_hx_tmp = false;
            				}
HXDLIN( 171)				if (_hx_tmp) {
HXLINE( 173)					this->canBeHit = true;
            				}
            				else {
HXLINE( 175)					this->canBeHit = false;
            				}
            			}
            			else {
HXLINE( 179)				bool _hx_tmp;
HXDLIN( 179)				if ((this->strumTime > (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 179)					_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + ::Conductor_obj::safeZoneOffset));
            				}
            				else {
HXLINE( 179)					_hx_tmp = false;
            				}
HXDLIN( 179)				if (_hx_tmp) {
HXLINE( 181)					this->canBeHit = true;
            				}
            				else {
HXLINE( 183)					this->canBeHit = false;
            				}
            			}
HXLINE( 186)			bool _hx_tmp;
HXDLIN( 186)			if ((this->strumTime < (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * ::Conductor_obj::timeScale)))) {
HXLINE( 186)				_hx_tmp = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 186)				_hx_tmp = false;
            			}
HXDLIN( 186)			if (_hx_tmp) {
HXLINE( 187)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 191)			this->canBeHit = false;
HXLINE( 193)			if ((this->strumTime <= ::Conductor_obj::songPosition)) {
HXLINE( 194)				this->wasGoodHit = true;
            			}
            		}
HXLINE( 197)		if (this->tooLate) {
HXLINE( 199)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 200)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
