...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Vs Impostor D-Side",56,45,d7,c4),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Shyllis",8e,92,c4,03));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Vs Impostor D-Side",56,45,d7,c4));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Vs Impostor D-Sides",5d,66,85,77));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.shyllis.vsimpostordsides",49,6d,ff,49));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Vs Impostor D-Sides",5d,66,85,77))
