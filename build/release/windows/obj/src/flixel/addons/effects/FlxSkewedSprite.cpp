...
HXLINE(  77)			 ::flixel::math::FlxBasePoint this1 = this->_point;
HXDLIN(  77)			this1->set_x(( (Float)(::Math_obj::floor(this1->x)) ));
HXDLIN(  77)			this1->set_y(( (Float)(::Math_obj::floor(this1->y)) ));
            		}
HXLINE(  79)		this->_matrix->translate(this->_point->x,this->_point->y);
HXLINE(  80)		camera->drawPixels(this->_frame,this->framePixels,this->_matrix,this->colorTransform,this->blend,this->antialiasing,null());
            	}
