...
HXLINE(  49)		::haxe::Log_obj::trace(jsonInput,::hx::SourceInfo(HX_("code/Song.hx",c7,b3,6e,9b),49,HX_("Song",f5,4f,31,37),HX_("loadFromJson",f8,fc,9c,5d)));
...
HXDLIN(  58)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("code/Song.hx",c7,b3,6e,9b),58,HX_("Song",f5,4f,31,37),HX_("loadFromJson",f8,fc,9c,5d)));
