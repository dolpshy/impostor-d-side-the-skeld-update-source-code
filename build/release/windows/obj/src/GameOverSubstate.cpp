...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_50_update,"GameOverSubstate","update",0x4cd2a460,"GameOverSubstate.update","GameOverSubstate.hx",50,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_87_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",87,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_96_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",96,0x01fbc1e7)
...
HXLINE(  21)		{
HXLINE(  21)			::String _g = ( (::String)(::PlayState_obj::SONG->__Field(HX_("player1",b0,09,15,8a),::hx::paccDynamic)) );
HXLINE(  24)			daBf = HX_("bf",c4,55,00,00);
            		}
HXLINE(  27)		super::__construct();
HXLINE(  29)		::Conductor_obj::songPosition = ( (Float)(0) );
HXLINE(  31)		this->bf =  ::Boyfriend_obj::__alloc( HX_CTX ,x,y,daBf);
HXLINE(  32)		this->bf->set_alpha(( (Float)(0) ));
HXLINE(  33)		this->add(this->bf);
HXLINE(  35)		Float _hx_tmp = this->bf->getGraphicMidpoint(null())->x;
HXDLIN(  35)		this->camFollow =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,_hx_tmp,this->bf->getGraphicMidpoint(null())->y,1,1);
HXLINE(  36)		this->add(this->camFollow);
HXLINE(  38)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN(  38)		_hx_tmp1->play(::Paths_obj::sound((HX_("fnf_loss_sfx",6a,36,72,11) + this->stageSuffix),null()),null(),null(),null(),null(),null());
HXLINE(  39)		::Conductor_obj::changeBPM(( (Float)(100) ));
HXLINE(  43)		{
HXLINE(  43)			 ::flixel::math::FlxBasePoint this1 = ::flixel::FlxG_obj::camera->scroll;
HXDLIN(  43)			this1->set_x(( (Float)(0) ));
HXDLIN(  43)			this1->set_y(( (Float)(0) ));
            		}
HXLINE(  44)		::flixel::FlxG_obj::camera->target = null();
HXLINE(  46)		this->bf->playAnim(HX_("firstDeath",e4,d8,fc,14),null(),null(),null());
            	}
...
void GameOverSubstate_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_50_update)
HXLINE(  51)		this->super::update(elapsed);
HXLINE(  53)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE(  55)			this->endBullshit();
            		}
HXLINE(  58)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE(  60)			{
HXLINE(  60)				 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN(  60)				_this->cleanup(_this->autoDestroy,true);
            			}
HXLINE(  62)			if (::PlayState_obj::isStoryMode) {
HXLINE(  63)				 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  63)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(  63)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
            			else {
HXLINE(  65)				 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  65)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(  65)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
HXLINE(  66)			::PlayState_obj::loadRep = false;
            		}
HXLINE(  69)		bool _hx_tmp;
HXDLIN(  69)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  69)			_hx_tmp = (this->bf->animation->_curAnim->curFrame == 12);
            		}
            		else {
HXLINE(  69)			_hx_tmp = false;
            		}
HXDLIN(  69)		if (_hx_tmp) {
HXLINE(  71)			::flixel::FlxG_obj::camera->follow(this->camFollow,::flixel::FlxCameraFollowStyle_obj::LOCKON_dyn(),((Float)0.01));
            		}
HXLINE(  74)		bool _hx_tmp1;
HXDLIN(  74)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  74)			_hx_tmp1 = this->bf->animation->_curAnim->finished;
            		}
            		else {
...
HXDLIN(  76)			_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOver",66,92,de,b5) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
            		}
HXLINE(  79)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE(  81)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
            	}


void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_87_beatHit)
HXDLIN(  87)		this->super::beatHit();
            	}


void GameOverSubstate_obj::endBullshit(){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_96_endBullshit)
HXDLIN(  96)		if (!(this->isEnding)) {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_106_endBullshit)
HXLINE( 106)					 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
HXLINE( 104)				::flixel::FlxG_obj::camera->fade(-16777216,2,false, ::Dynamic(new _hx_Closure_0()),null());
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  98)			this->isEnding = true;
HXLINE(  99)			this->bf->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 100)			{
...
HXDLIN( 101)			_hx_tmp->play(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOverEnd",15,2d,a9,8d) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null(),null(),null());
HXLINE( 102)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.7), ::Dynamic(new _hx_Closure_1()),null());
            		}
            	}
