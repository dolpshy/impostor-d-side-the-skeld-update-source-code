...
class HXCPP_CLASS_ATTRIBUTES AttachedSprite_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(::String file,::String library,::String anim, ::Dynamic __o_loop);
		...
		static ::hx::ObjectPtr< AttachedSprite_obj > __new(::String file,::String library,::String anim, ::Dynamic __o_loop);
		static ::hx::ObjectPtr< AttachedSprite_obj > __alloc(::hx::Ctx *_hx_ctx,::String file,::String library,::String anim, ::Dynamic __o_loop);
