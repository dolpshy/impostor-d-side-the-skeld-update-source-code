...
class HXCPP_CLASS_ATTRIBUTES Ratings_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String GenerateFCRankPsych();
		static ::Dynamic GenerateFCRankPsych_dyn();

		static ::String GenerateLetterRankPsych(Float accuracy);
		static ::Dynamic GenerateLetterRankPsych_dyn();
		...
		static ::String CalculateRankingPsych(int score,int scoreDef,int nps,int maxNPS,Float accuracy);
		static ::Dynamic CalculateRankingPsych_dyn();
